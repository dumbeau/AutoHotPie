...
export class NewPieWizardComponent {
  ...
  finishWizard() {
    ...
    console.log('Creating pie with name: ' + this.pieName + ' and hotkey: ' + this.hotkey + ' and activation mode: ' + this.activationMode);

    window.electronAPI.createPieMenu(this.pieName, this.hotkey, this.activationMode, this.style);
  }
