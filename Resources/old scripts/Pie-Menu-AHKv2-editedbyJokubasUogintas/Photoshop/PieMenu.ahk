...
FileReadLine, kPieHotkey_Modifiers, %A_ScriptDir%\Resources\settingsfile.txt, 474
FileReadLine, lPieHotkey_Modifiers, %A_ScriptDir%\Resources\settingsfile.txt, 475
...
PieKillSwitch:
	...
	ClearDrawGDIP()
	EndDrawGDIP()
	SetUpGDIP(,,"Hide") ;; //changed// added a hide call
	return
	}
...
;Boop-boop-boopa-doop
	...
	ClearDrawGDIP()
	EndDrawGDIP()
	SetUpGDIP(,,"Hide") ; //changed// this hides the gui so it doesn't interfere with some programs
	BlockLButton := 0
		If PieMode = 0
			{
			If (dist < 22)
